            ...
            <div className='md:px-36 py-5 px-4 sticky top-0 z-10'>
                <div className='flex justify-between items-center'>
                    ...
                    <div className='pt-10 pr-20 hidden xl:block'>
                        <ul className='flex gap-8 font-medium text-[#696864] text-lg'>
                            <a href=""><li>НАЧАЛО</li></a>
                            <a href=""><li>ЗА НАС</li></a>
                            <a href=""><li>КОМИКС</li></a>
                            <a href=""><li>БЛОГ</li></a>
                ...
                >
                    <ul className='flex flex-col items-center gap-4 py-4 font-medium text-[#696864] text-lg'>
                        <a href=""><li>НАЧАЛО</li></a>
                        <a href=""><li>ЗА НАС</li></a>
                        <a href=""><li>КОМИКС</li></a>
                        <a href=""><li>БЛОГ</li></a>
                        <a href=""><li>КОНТАКТИ</li></a>
                        <a href=""><li> <div className='rounded-full bg-gray-600 px-7 py-5 text-white font-medium'>ВИЖ КОМИКС</div></li></a>
                    </ul>
                </div>
            </div>
        </div>
