...
export const images: Image[] = [
    ...
    },
    {
        ...
        src: "/lubov.png",
        alt: "Lubov Snimka",
        description: "Това е LV, спокойно не говорим за Louis Vuitton, а за Любов Василева. Силата ѝ е да отговаря на съобщения след 20 години, така че пишете  предварително за да получите отговор навреме.",
    },
];
